...
private:
	...
	std::string _face_predictor_set_path = "";
	std::string _shape_predictor_set_path = "";
...
public:
	...
	[[nodiscard]] std::string facePredictorSetPath() const
	{
		return _face_predictor_set_path;
	}

	[[nodiscard]] std::string shapePredictorSetPath() const
	{
		return _shape_predictor_set_path;
	}
};
