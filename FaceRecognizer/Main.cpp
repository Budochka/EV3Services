// FaceRecognizer.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    channel.bindQueue("EV3", "images", "images.face");

    FaceRecognizer fr(cfg.faceRecognitionSetPath(), cfg.knownFacesSetPath());

    RabbitConsumer consumer(channel, fr);
    consumer.Run();
