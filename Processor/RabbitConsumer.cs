...
_logs.Info("Connection created");
 _channel = await _connection.CreateChannelAsync();
    ...
    var queueDeclareResult = await _channel.QueueDeclareAsync();
      ...
      await _channel.QueueBindAsync(queue: queueName, exchange: "EV3", routingKey: "sensors.*");
            await _channel.QueueBindAsync(queue: queueName, exchange: "EV3", routingKey: "state.*");
